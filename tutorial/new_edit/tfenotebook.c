...
static TfeTextView *get_current_textview (GtkNotebook *nb) 
{
    int i;
    GtkWidget *scr;
    GtkWidget *tv;
...
static void file_changed_cb (TfeTextView *tv, GtkNotebook *nb)
{
    GtkWidget *scr;
    GtkWidget *label;
    GFile *file;
...
static void notebook_page_build (GtkNotebook *nb, GtkWidget *tv, char *filename) 
{
